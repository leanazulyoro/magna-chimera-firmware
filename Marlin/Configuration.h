 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 100, 5000 } // { 500, 500, 100, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51, 1, -3.5 }
...
#define X_MIN_POS -27 // -14 (Since using a chimera hotend, the right nozzle can't reach to -14)
#define Y_MIN_POS -15
#define Z_MIN_POS 0
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (20*60) } // { (80*60), (80*60), (20*60) }
